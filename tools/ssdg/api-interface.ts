...
interface 기본프로토콜형태
{
    0: null | string, // 요청타입 | 응답결과 (성공 | 실패에대한 정보)
    1: null | {} // 내용
}
...
{
    "name": {0: string, 1: string}, // 앞부분이 더 잘 노출되는 이름
...
interface 온디바이스_요청 extends 기본프로토콜형태
{
    0: "r-ondevice",
    1: null
}
...
interface 온디바이스_응답 extends 기본프로토콜형태
{
    0: null,
    1: {
        "sool-id2info": {
...
interface 계정가입_요청 extends 기본프로토콜형태
{
    0: "c-acct",
    1: {
...
interface 계정가입_응답 extends 기본프로토콜형태
{
    0: null | "email" | "name",
...
interface 계정로그인_요청 extends 기본프로토콜형태
{
    0: "r-acct",
    1: {
        "email": string,
...
interface 계정로그인_응답 extends 기본프로토콜형태
{
    0: null | "email" | "pwd",
        // 존재하지 않는 이메일입니다
        // 비밀번호 불일치
...
interface 계정변경_요청 extends 기본프로토콜형태
{
    0: "u-acct",
    1: {
        "name": null | string,
...
interface 계정변경_응답 extends 기본프로토콜형태
{
...
interface 계정탈퇴_요청 extends 기본프로토콜형태
{
    0: "d-acct",
    1: {
        "usr-info": UsrInfo
...
interface 계정탈퇴_응답 extends 기본프로토콜형태
{
    0: null | 계정_인증_관련_오류_응답,
    1: null
}
...
interface 유저술관계_등록변경_요청 extends 기본프로토콜형태
{
    0: "cu-usr-sool",
    1: {
        "usr-info": UsrInfo,
...
interface 유저술관계_등록변경_응답 extends 기본프로토콜형태
{
...
interface 술정보_요청 extends 기본프로토콜형태
{
    0: "r-sool",
    1: {
...
interface 술정보_응답 extends 기본프로토콜형태
{
    0: null | "sool-id",
    1: null | {
        "review-data": {
