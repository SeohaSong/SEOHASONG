...
const 온디바이스데이터_응답 = [
    null,
    {
        "sool-id2info": [
            {
                "name": ["금정산성 막걸리", "금정산성 토산주"], // 앞부분이 더 잘 노출되는 이름
                "alias": ["누리끼리 막걸리", "금산탁주", "어쩌구저쩌구"],
                "price": [11000, 13500, 21000], // 가격 오름차순 정렬 필수
                "img": ["img-url1", "img-url2"], // 파일 사이즈 기준으로 오름차순 필수
                "type": "탁주",
                "proof": 7, // 도수
                "vol": 750, // 용량, ml기준
                "taste": [3, 5, 1, 2, 4], // 기본 설정된 디폴트 5개 미각
                "pairing": [""],
                "scent": [""],
                "knowhow": [], // 맛있게 마시기
                "intro": [
                    `
                        금정산성막걸리는 술빛기에 적합한 온도와 습도가 유지되는 해발 400m의 청정 환경을 갖춘 금정산성마을에서 제조된다.
                    `,
                    `
                        금정산성막걸리는 깨끗한 자연환경속에서 발효된 자연산 누룩과 250m의 암반수를 사용하여 금정산성.....어쩌구저쩌구..
                    `
                ],
                "story": [
                    `
                        금정산성막걸리는 그 유래가 정확하지는 않지만 조선 초기부터 이곳 화전민이 생계수단으로 누룩을 빚기 시작한데서 비로소디었으며 숙종...
                    `                    
                ]
            }, // sool-id 0
            {술ID_1번에_해당하는_내용들: "내용들~"},
            {술ID_2번에_해당하는_내용들: "내용들~"},
            {술ID_3번에_해당하는_내용들: "내용들~"}
        ]
    }
]
...
const 술정보_응답 = [
    ...
    null | {
        ...
        "info": null | {
            ...
            "taste-n": 20, // 맛정보 수
            "review-n": 2, // 리뷰 수
            "cluster": [23, 842, 11, 2, 499] // 사용한 유사도 기준 정렬 필수, 비슷한 술
